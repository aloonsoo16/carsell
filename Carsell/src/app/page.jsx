  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="flex flex-col justify-center p-4 md:p-8">
        ...
        >
          <div
            className="absolute inset-0 bg-background/70 rounded-lg"
            style={{
              opacity: 0.8,
            }}
          ></div>
          ...
          <div className="relative z-10 w-full md:w-2/4 h-full">
            <Card className="backdrop-sepia-0 bg-background/70 border-none">
              <CardHeader>
        ...
        <div className="w-full px-1 py-5 md:px-5 lg:px-10 gap-4 flex flex-col font-semibold text-sm md:text-base">
          <span>
          ...
          <span>
            Te invito a explorar la aplicación. Es recomendable registrarse para
            tener acceso total y una mejor experiencia. Puedes utilizar un
            correo inexistente para registrarte ya que no se requiere
            verificación.
          </span>
        </div>
      </main>
      <footer className="border-t py-6 px-4">
        <div className="flex flex-wrap gap-y-2 items-center justify-between px-4 ">
          {/* Enlace izquierda */}
          <Link
